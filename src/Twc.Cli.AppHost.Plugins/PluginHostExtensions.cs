...
public static class PluginHostExtensions
{
    ...
    [Obsolete("Use DiscoverAndRegisterPlugins(...) which also returns the discovered plugins.")]
    public static CommandTypeCatalog RegisterDiscoveredPlugins(
        this IServiceCollection services,
        IConfigurator configurator,
        SemanticVersion hostVersion)
        => services.DiscoverAndRegisterPlugins(configurator, hostVersion).CommandTypes;
}
